...
//
CjfifDecode::CjfifDecode(CDocLog* pLog,CwindowBuf* pWBuf,CimgDecode* pImgDec, CDbSigs* DbSigs)
{
...
//
void CjfifDecode::SetStatusBar(void* pStatBar)
{
    return;
}
...
CStr2 CjfifDecode::LookupMakerCanonTag(unsigned nMainTag,unsigned nSubTag,unsigned nVal)
{
    ...
    case 0x0001:
        ...
        {
        case 0x0001:
            sRetVal.strTag = _T("Canon.Cs1.Macro");
            break; // Short Macro mode
        case 0x0002:
            sRetVal.strTag = _T("Canon.Cs1.Selftimer");
            break; // Short Self timer
        case 0x0003:
            sRetVal.strTag = _T("Canon.Cs1.Quality");
            if (nVal == 2)
            {
                sRetVal.strVal = _T("norm");
            }
            else if (nVal == 3)
            {
                sRetVal.strVal = _T("fine");
            }
            else if (nVal == 5)
            {
                sRetVal.strVal = _T("superfine");
            }
            else
            {
                sRetVal.strVal = _T("?");
            ...
            break; // Short Quality
        case 0x0004:
            sRetVal.strTag = _T("Canon.Cs1.FlashMode");
            break; // Short Flash mode setting
        case 0x0005:
            sRetVal.strTag = _T("Canon.Cs1.DriveMode");
            break; // Short Drive mode setting
        case 0x0007:
            sRetVal.strTag = _T("Canon.Cs1.FocusMode"); // Short Focus mode setting
            switch(nVal)
            {
            case 0 :
                sRetVal.strVal = _T("One-shot");
                break;
            case 1 :
                sRetVal.strVal = _T("AI Servo");
                break;
            case 2 :
                sRetVal.strVal = _T("AI Focus");
                break;
            case 3 :
                sRetVal.strVal = _T("Manual Focus");
                break;
            case 4 :
                sRetVal.strVal = _T("Single");
                break;
            case 5 :
                sRetVal.strVal = _T("Continuous");
                break;
            case 6 :
                sRetVal.strVal = _T("Manual Focus");
                break;
            ...
            break;
        case 0x000a:
            sRetVal.strTag = _T("Canon.Cs1.ImageSize"); // Short Image size
            if (nVal == 0)
            {
                sRetVal.strVal = _T("Large");
            }
            else if (nVal == 1)
            {
                sRetVal.strVal = _T("Medium");
            }
            else if (nVal == 2)
            {
                sRetVal.strVal = _T("Small");
            }
            else
            {
                sRetVal.strVal = _T("?");
            ...
            break;
        case 0x000b:
            sRetVal.strTag = _T("Canon.Cs1.EasyMode");
            break; // Short Easy shooting mode
        case 0x000c:
            sRetVal.strTag = _T("Canon.Cs1.DigitalZoom");
            break; // Short Digital zoom
        case 0x000d:
            sRetVal.strTag = _T("Canon.Cs1.Contrast");
            break; // Short Contrast setting
        case 0x000e:
            sRetVal.strTag = _T("Canon.Cs1.Saturation");
            break; // Short Saturation setting
        case 0x000f:
            sRetVal.strTag = _T("Canon.Cs1.Sharpness");
            break; // Short Sharpness setting
        case 0x0010:
            sRetVal.strTag = _T("Canon.Cs1.ISOSpeed");
            break; // Short ISO speed setting
        case 0x0011:
            sRetVal.strTag = _T("Canon.Cs1.MeteringMode");
            break; // Short Metering mode setting
        case 0x0012:
            sRetVal.strTag = _T("Canon.Cs1.FocusType");
            break; // Short Focus type setting
        case 0x0013:
            sRetVal.strTag = _T("Canon.Cs1.AFPoint");
            break; // Short AF point selected
        case 0x0014:
            sRetVal.strTag = _T("Canon.Cs1.ExposureProgram");
            break; // Short Exposure mode setting
        case 0x0016:
            sRetVal.strTag = _T("Canon.Cs1.LensType");
            break; //
        case 0x0017:
            sRetVal.strTag = _T("Canon.Cs1.Lens");
            break; // Short 'long' and 'short' focal length of lens (in 'focal m_nImgUnits') and 'focal m_nImgUnits' per mm
        case 0x001a:
            sRetVal.strTag = _T("Canon.Cs1.MaxAperture");
            break; //
        case 0x001b:
            sRetVal.strTag = _T("Canon.Cs1.MinAperture");
            break; //
        case 0x001c:
            sRetVal.strTag = _T("Canon.Cs1.FlashActivity");
            break; // Short Flash activity
        case 0x001d:
            sRetVal.strTag = _T("Canon.Cs1.FlashDetails");
            break; // Short Flash details
        case 0x0020:
            sRetVal.strTag = _T("Canon.Cs1.FocusMode");
    ...
    case 0x0004:
        ...
        {
        case 0x0002:
            sRetVal.strTag = _T("Canon.Cs2.ISOSpeed");
            break; // Short ISO speed used
        case 0x0004:
            sRetVal.strTag = _T("Canon.Cs2.TargetAperture");
            break; // Short Target Aperture
        case 0x0005:
            sRetVal.strTag = _T("Canon.Cs2.TargetShutterSpeed");
            break; // Short Target shutter speed
        case 0x0007:
            sRetVal.strTag = _T("Canon.Cs2.WhiteBalance");
            break; // Short White balance setting
        case 0x0009:
            sRetVal.strTag = _T("Canon.Cs2.Sequence");
            break; // Short Sequence number (if in a continuous burst)
        case 0x000e:
            sRetVal.strTag = _T("Canon.Cs2.AFPointUsed");
            break; // Short AF point used
        case 0x000f:
            sRetVal.strTag = _T("Canon.Cs2.FlashBias");
            break; // Short Flash bias
        case 0x0013:
            sRetVal.strTag = _T("Canon.Cs2.SubjectDistance");
            break; // Short Subject distance (m_nImgUnits are not clear)
        case 0x0015:
            sRetVal.strTag = _T("Canon.Cs2.ApertureValue");
            break; // Short Aperture
        case 0x0016:
            sRetVal.strTag = _T("Canon.Cs2.ShutterSpeedValue");
    ...
    case 0x000F:
        ...
        case 0x0001:
            sRetVal.strTag = _T("Canon.Cf.NoiseReduction");
            break; // Short Long exposure noise reduction
        case 0x0002:
            sRetVal.strTag = _T("Canon.Cf.ShutterAeLock");
            break; // Short Shutter/AE lock buttons
        case 0x0003:
            sRetVal.strTag = _T("Canon.Cf.MirrorLockup");
            break; // Short Mirror lockup
        case 0x0004:
            sRetVal.strTag = _T("Canon.Cf.ExposureLevelIncrements");
            break; // Short Tv/Av and exposure level
        case 0x0005:
            sRetVal.strTag = _T("Canon.Cf.AFAssist");
            break; // Short AF assist light
        case 0x0006:
            sRetVal.strTag = _T("Canon.Cf.FlashSyncSpeedAv");
            break; // Short Shutter speed in Av mode
        case 0x0007:
            sRetVal.strTag = _T("Canon.Cf.AEBSequence");
            break; // Short AEB sequence/auto cancellation
        case 0x0008:
            sRetVal.strTag = _T("Canon.Cf.ShutterCurtainSync");
            break; // Short Shutter curtain sync
        case 0x0009:
            sRetVal.strTag = _T("Canon.Cf.LensAFStopButton");
            break; // Short Lens AF stop button Fn. Switch
        case 0x000a:
            sRetVal.strTag = _T("Canon.Cf.FillFlashAutoReduction");
            break; // Short Auto reduction of fill flash
        case 0x000b:
            sRetVal.strTag = _T("Canon.Cf.MenuButtonReturn");
            break; // Short Menu button return position
        case 0x000c:
            sRetVal.strTag = _T("Canon.Cf.SetButtonFunction");
            break; // Short SET button func. when shooting
        case 0x000d:
            sRetVal.strTag = _T("Canon.Cf.SensorCleaning");
            break; // Short Sensor cleaning
        case 0x000e:
            sRetVal.strTag = _T("Canon.Cf.SuperimposedDisplay");
            break; // Short Superimposed display
        case 0x000f:
            sRetVal.strTag = _T("Canon.Cf.ShutterReleaseNoCFCard");
    ...
    */
    ...
    case 0x0012:
        ...
        {
        case 0x0002:
            sRetVal.strTag = _T("Canon.Pi.ImageWidth");
            break; //
        case 0x0003:
            sRetVal.strTag = _T("Canon.Pi.ImageHeight");
            break; //
        case 0x0004:
            sRetVal.strTag = _T("Canon.Pi.ImageWidthAsShot");
            break; //
        case 0x0005:
            sRetVal.strTag = _T("Canon.Pi.ImageHeightAsShot");
            break; //
        case 0x0016:
            sRetVal.strTag = _T("Canon.Pi.AFPointsUsed");
            break; //
        case 0x001a:
            sRetVal.strTag = _T("Canon.Pi.AFPointsUsed20D");
            break; //
        default:
...
CString CjfifDecode::LookupExifTag(CString strSect,unsigned nTag,bool &bUnknown)
{
    ...
    if (strSect == _T("IFD0"))
    {
        ...
        case 0x011B:
            return _T("YResolution");
            break; // unsigned rational 1
        case 0x0128:
            return _T("ResolutionUnit");
...
//NEW: The following were found in IFD0 even though they should just be SubIFD?
        case 0xA401:
            return _T("CustomRendered");
            break;
        case 0xA402:
            return _T("ExposureMode");
            break;
        case 0xA403:
            return _T("WhiteBalance");
            break;
        case 0xA406:
            return _T("SceneCaptureType");
            break;
    ...
    else if (strSect == _T("SubIFD"))
    {
        ...
        {
        case 0x00fe:
            return _T("NewSubfileType");
            break; //  unsigned long 1
        case 0x00ff:
            return _T("SubfileType");
            break; //  unsigned short 1
        case 0x012d:
            return _T("TransferFunction");
        ...
        case 0x0142:
            ...
            break; //  unsigned short 1
        case 0x0143:
            return _T("TileLength");
            break; //  unsigned short 1
        case 0x0144:
            return _T("TileOffsets");
            break; //  unsigned long
        case 0x0145:
            return _T("TileByteCounts");
            break; //  unsigned short
        case 0x014a:
            return _T("SubIFDs");
            break; //  unsigned long
        case 0x015b:
            return _T("JPEGTables");
            break; //  undefined
        case 0x828d:
            return _T("CFARepeatPatternDim");
            break; //  unsigned short 2
        case 0x828e:
            return _T("CFAPattern");
            break; //  unsigned byte
        case 0x828f:
            return _T("BatteryLevel");
            break; //  unsigned rational 1
        case 0x829A:
            return _T("ExposureTime");
            break;
        case 0x829D:
            return _T("FNumber");
            break;
        case 0x83bb:
            ...
            break; //  unsigned long
        case 0x8773:
            return _T("InterColorProfile");
            break; //  undefined
        case 0x8822:
            return _T("ExposureProgram");
            break;
        case 0x8824:
            return _T("SpectralSensitivity");
            break; //  ascii string
        case 0x8825:
            return _T("GPSInfo");
            break; //  unsigned long 1
        case 0x8827:
            return _T("ISOSpeedRatings");
            break;
        case 0x8828:
            return _T("OECF");
            break; //  undefined
        case 0x8829:
            ...
            break; //  unsigned short 1
        case 0x882a:
            return _T("TimeZoneOffset");
            break; //  signed short 1
        case 0x882b:
            return _T("SelfTimerMode");
            break; //  unsigned short 1
        case 0x9000:
            return _T("ExifVersion");
            break;
        case 0x9003:
            return _T("DateTimeOriginal");
            break;
        case 0x9004:
            return _T("DateTimeDigitized");
            break;
        case 0x9101:
            return _T("ComponentsConfiguration");
            break;
        case 0x9102:
            return _T("CompressedBitsPerPixel");
            break;
        case 0x9201:
            return _T("ShutterSpeedValue");
            break;
        case 0x9202:
            return _T("ApertureValue");
            break;
        case 0x9203:
            return _T("BrightnessValue");
            break;
        case 0x9204:
            return _T("ExposureBiasValue");
            break;
        case 0x9205:
            return _T("MaxApertureValue");
            break;
        case 0x9206:
            return _T("SubjectDistance");
            break;
        case 0x9207:
            return _T("MeteringMode");
            break;
        case 0x9208:
            return _T("LightSource");
            break;
        case 0x9209:
            return _T("Flash");
            break;
        case 0x920A:
            return _T("FocalLength");
            break;
        case 0x920b:
            return _T("FlashEnergy");
            break; //  unsigned rational 1
        case 0x920c:
            return _T("SpatialFrequencyResponse");
            break; //  undefined
        case 0x920d:
            return _T("Noise");
            break; //  undefined
        case 0x9211:
            return _T("ImageNumber");
            break; //  unsigned long 1
        case 0x9212:
            return _T("SecurityClassification");
            break; //  ascii string 1
        case 0x9213:
            return _T("ImageHistory");
            break; //  ascii string
        case 0x9214:
            return _T("SubjectLocation");
            break; //  unsigned short 4
        case 0x9215:
            return _T("ExposureIndex");
            break; //  unsigned rational 1
        case 0x9216:
            return _T("TIFF/EPStandardID");
            break; //  unsigned byte 4
        case 0x927C:
            return _T("MakerNote");
            break;
        case 0x9286:
            return _T("UserComment");
            break;
        case 0x9290:
            return _T("SubSecTime");
            break; //  ascii string
        case 0x9291:
            return _T("SubSecTimeOriginal");
            break; //  ascii string
        case 0x9292:
            return _T("SubSecTimeDigitized");
            break; //  ascii string
        case 0xA000:
            return _T("FlashPixVersion");
            break;
        case 0xA001:
            return _T("ColorSpace");
            break;
        case 0xA002:
            return _T("ExifImageWidth");
            break;
        case 0xA003:
            return _T("ExifImageHeight");
            break;
        case 0xA004:
            return _T("RelatedSoundFile");
            break;
        case 0xA005:
            return _T("ExifInteroperabilityOffset");
            break;
        case 0xa20b:
            return _T("FlashEnergy  unsigned");
            break; // rational 1
        case 0xa20c:
            return _T("SpatialFrequencyResponse");
            break; //  unsigned short 1
        case 0xA20E:
            return _T("FocalPlaneXResolution");
            break;
        case 0xA20F:
            return _T("FocalPlaneYResolution");
            break;
        case 0xA210:
            return _T("FocalPlaneResolutionUnit");
            break;
        case 0xa214:
            return _T("SubjectLocation");
            break; //  unsigned short 1
        case 0xa215:
            ...
            break; //  unsigned rational 1
        case 0xA217:
            return _T("SensingMethod");
            break;
        case 0xA300:
            return _T("FileSource");
            break;
        case 0xA301:
            return _T("SceneType");
            break;
        ...
        case 0xa40b:
            return _T("DeviceSettingDescription");
            break; // Undefined Device settings description
        case 0xa40c:
            return _T("SubjectDistanceRange");
            break; // Short Subject distance range
        case 0xa420:
            return _T("ImageUniqueID");
    ...
    else if (strSect == _T("InteropIFD"))
    {
        ...
        {
        case 0x0001:
            return _T("InteroperabilityIndex");
            break;
        case 0x0002:
            return _T("InteroperabilityVersion");
            break;
        case 0x1000:
            return _T("RelatedImageFileFormat");
            break;
        case 0x1001:
            return _T("RelatedImageWidth");
            break;
        case 0x1002:
            return _T("RelatedImageLength");
            break;
    ...
    else if (strSect == _T("GPSIFD"))
    {
        ...
        {
        case 0x0000:
            return _T("GPSVersionID");
            break;
        case 0x0001:
            return _T("GPSLatitudeRef");
            break;
        case 0x0002:
            return _T("GPSLatitude");
            break;
        case 0x0003:
            return _T("GPSLongitudeRef");
            break;
        case 0x0004:
            return _T("GPSLongitude");
            break;
        case 0x0005:
            return _T("GPSAltitudeRef");
            break;
        case 0x0006:
            return _T("GPSAltitude");
            break;
        case 0x0007:
            return _T("GPSTimeStamp");
            break;
        case 0x0008:
            return _T("GPSSatellites");
            break;
        case 0x0009:
            return _T("GPSStatus");
            break;
        case 0x000A:
            return _T("GPSMeasureMode");
            break;
        case 0x000B:
            return _T("GPSDOP");
            break;
        case 0x000C:
            return _T("GPSSpeedRef");
            break;
        case 0x000D:
            return _T("GPSSpeed");
            break;
        case 0x000E:
            return _T("GPSTrackRef");
            break;
        case 0x000F:
            return _T("GPSTrack");
            break;
        case 0x0010:
            return _T("GPSImgDirectionRef");
            break;
        case 0x0011:
            return _T("GPSImgDirection");
            break;
        case 0x0012:
            return _T("GPSMapDatum");
            break;
        case 0x0013:
            return _T("GPSDestLatitudeRef");
            break;
        case 0x0014:
            return _T("GPSDestLatitude");
            break;
        case 0x0015:
            return _T("GPSDestLongitudeRef");
            break;
        case 0x0016:
            return _T("GPSDestLongitude");
            break;
        case 0x0017:
            return _T("GPSDestBearingRef");
            break;
        case 0x0018:
            return _T("GPSDestBearing");
            break;
        case 0x0019:
            return _T("GPSDestDistanceRef");
            break;
        case 0x001A:
            return _T("GPSDestDistance");
            break;
        case 0x001B:
            return _T("GPSProcessingMethod");
            break;
        case 0x001C:
            return _T("GPSAreaInformation");
            break;
        case 0x001D:
            return _T("GPSDateStamp");
            break;
        case 0x001E:
            return _T("GPSDifferential");
            break;
    ...
    else if (strSect == _T("MakerIFD"))
    {
        ...
        if (m_strImgExifMake == _T("Canon"))
        {
            ...
            {
            case 0x0001:
                return _T("Canon.CameraSettings1");
                break;
            case 0x0004:
                return _T("Canon.CameraSettings2");
                break;
            case 0x0006:
                return _T("Canon.ImageType");
                break;
            case 0x0007:
                return _T("Canon.FirmwareVersion");
                break;
            case 0x0008:
                return _T("Canon.ImageNumber");
                break;
            case 0x0009:
                return _T("Canon.OwnerName");
                break;
            case 0x000C:
                return _T("Canon.SerialNumber");
                break;
            case 0x000F:
                return _T("Canon.CustomFunctions");
                break;
            case 0x0012:
                return _T("Canon.PictureInfo");
                break;
            case 0x00A9:
                return _T("Canon.WhiteBalanceTable");
                break;
        ...
        else if (m_strImgExifMake == _T("SIGMA"))
        {
            ...
            {
            case 0x0002:
                return _T("Sigma.SerialNumber");
                break; // Ascii Camera serial number
            case 0x0003:
                return _T("Sigma.DriveMode");
                break; // Ascii Drive Mode
            case 0x0004:
                return _T("Sigma.ResolutionMode");
                break; // Ascii Resolution Mode
            case 0x0005:
                return _T("Sigma.AutofocusMode");
                break; // Ascii Autofocus mode
            case 0x0006:
                return _T("Sigma.FocusSetting");
                break; // Ascii Focus setting
            case 0x0007:
                return _T("Sigma.WhiteBalance");
                break; // Ascii White balance
            case 0x0008:
                return _T("Sigma.ExposureMode");
                break; // Ascii Exposure mode
            case 0x0009:
                return _T("Sigma.MeteringMode");
                break; // Ascii Metering mode
            case 0x000a:
                return _T("Sigma.LensRange");
                break; // Ascii Lens focal length range
            case 0x000b:
                return _T("Sigma.ColorSpace");
                break; // Ascii Color space
            case 0x000c:
                return _T("Sigma.Exposure");
                break; // Ascii Exposure
            case 0x000d:
                return _T("Sigma.Contrast");
                break; // Ascii Contrast
            case 0x000e:
                return _T("Sigma.Shadow");
                break; // Ascii Shadow
            case 0x000f:
                return _T("Sigma.Highlight");
                break; // Ascii Highlight
            case 0x0010:
                return _T("Sigma.Saturation");
                break; // Ascii Saturation
            case 0x0011:
                return _T("Sigma.Sharpness");
                break; // Ascii Sharpness
            case 0x0012:
                return _T("Sigma.FillLight");
                break; // Ascii X3 Fill light
            case 0x0014:
                return _T("Sigma.ColorAdjustment");
                break; // Ascii Color adjustment
            case 0x0015:
                return _T("Sigma.AdjustmentMode");
                break; // Ascii Adjustment mode
            case 0x0016:
                return _T("Sigma.Quality");
                break; // Ascii Quality
            case 0x0017:
                return _T("Sigma.Firmware");
                break; // Ascii Firmware
            case 0x0018:
                return _T("Sigma.Software");
                break; // Ascii Software
            case 0x0019:
                return _T("Sigma.AutoBracket");
        ...
        else if (m_strImgExifMake == _T("SONY"))
        {
            ...
            {
            case 0xb021:
                return _T("Sony.ColorTemperature");
                break;
            case 0xb023:
                return _T("Sony.SceneMode");
                break;
            case 0xb024:
                return _T("Sony.ZoneMatching");
                break;
            case 0xb025:
                return _T("Sony.DynamicRangeOptimizer");
                break;
            case 0xb026:
                return _T("Sony.ImageStabilization");
                break;
            case 0xb027:
                return _T("Sony.LensID");
                break;
            case 0xb029:
                return _T("Sony.ColorMode");
                break;
            case 0xb040:
                return _T("Sony.Macro");
                break;
            case 0xb041:
                return _T("Sony.ExposureMode");
                break;
            case 0xb047:
                return _T("Sony.Quality");
                break;
            case 0xb04e:
                return _T("Sony.LongExposureNoiseReduction");
                break;
            default:
        ...
        else if (m_strImgExifMake == _T("NIKON"))
        {
            if (m_nImgExifMakeSubtype == 1)
            {
                ...
                {
                case 0x0001:
                    return _T("Nikon1.Version");
                    break; // Undefined Nikon Makernote version
                case 0x0002:
                    return _T("Nikon1.ISOSpeed");
                    break; // Short ISO speed setting
                case 0x0003:
                    return _T("Nikon1.ColorMode");
                    break; // Ascii Color mode
                case 0x0004:
                    return _T("Nikon1.Quality");
                    break; // Ascii Image quality setting
                case 0x0005:
                    return _T("Nikon1.WhiteBalance");
                    break; // Ascii White balance
                case 0x0006:
                    return _T("Nikon1.Sharpening");
                    break; // Ascii Image sharpening setting
                case 0x0007:
                    return _T("Nikon1.Focus");
                    break; // Ascii Focus mode
                case 0x0008:
                    return _T("Nikon1.Flash");
                    break; // Ascii Flash mode
                case 0x000f:
                    return _T("Nikon1.ISOSelection");
                    break; // Ascii ISO selection
                case 0x0010:
                    return _T("Nikon1.DataDump");
                    break; // Undefined Data dump
                case 0x0080:
                    return _T("Nikon1.ImageAdjustment");
                    break; // Ascii Image adjustment setting
                case 0x0082:
                    return _T("Nikon1.Adapter");
                    break; // Ascii Adapter used
                case 0x0085:
                    return _T("Nikon1.FocusDistance");
                    break; // Rational Manual focus distance
                case 0x0086:
                    return _T("Nikon1.DigitalZoom");
                    break; // Rational Digital zoom setting
                case 0x0088:
                    return _T("Nikon1.AFFocusPos");
            ...
            else if (m_nImgExifMakeSubtype == 2)
            {
                ...
                {
                case 0x0003:
                    return _T("Nikon2.Quality");
                    break; // Short Image quality setting
                case 0x0004:
                    return _T("Nikon2.ColorMode");
                    break; // Short Color mode
                case 0x0005:
                    return _T("Nikon2.ImageAdjustment");
                    break; // Short Image adjustment setting
                case 0x0006:
                    return _T("Nikon2.ISOSpeed");
                    break; // Short ISO speed setting
                case 0x0007:
                    return _T("Nikon2.WhiteBalance");
                    break; // Short White balance
                case 0x0008:
                    return _T("Nikon2.Focus");
                    break; // Rational Focus mode
                case 0x000a:
                    return _T("Nikon2.DigitalZoom");
                    break; // Rational Digital zoom setting
                case 0x000b:
                    return _T("Nikon2.Adapter");
            ...
            else if (m_nImgExifMakeSubtype == 3)
            {
                ...
                {
                case 0x0001:
                    return _T("Nikon3.Version");
                    break; // Undefined Nikon Makernote version
                case 0x0002:
                    return _T("Nikon3.ISOSpeed");
                    break; // Short ISO speed used
                case 0x0003:
                    return _T("Nikon3.ColorMode");
                    break; // Ascii Color mode
                case 0x0004:
                    return _T("Nikon3.Quality");
                    break; // Ascii Image quality setting
                case 0x0005:
                    return _T("Nikon3.WhiteBalance");
                    break; // Ascii White balance
                case 0x0006:
                    return _T("Nikon3.Sharpening");
                    break; // Ascii Image sharpening setting
                case 0x0007:
                    return _T("Nikon3.Focus");
                    break; // Ascii Focus mode
                case 0x0008:
                    return _T("Nikon3.FlashSetting");
                    break; // Ascii Flash setting
                case 0x0009:
                    return _T("Nikon3.FlashMode");
                    break; // Ascii Flash mode
                case 0x000b:
                    return _T("Nikon3.WhiteBalanceBias");
                    break; // SShort White balance bias
                case 0x000e:
                    return _T("Nikon3.ExposureDiff");
                    break; // Undefined Exposure difference
                case 0x000f:
                    return _T("Nikon3.ISOSelection");
                    break; // Ascii ISO selection
                case 0x0010:
                    return _T("Nikon3.DataDump");
                    break; // Undefined Data dump
                case 0x0011:
                    return _T("Nikon3.ThumbOffset");
                    break; // Long Thumbnail IFD offset
                case 0x0012:
                    return _T("Nikon3.FlashComp");
                    break; // Undefined Flash compensation setting
                case 0x0013:
                    return _T("Nikon3.ISOSetting");
                    break; // Short ISO speed setting
                case 0x0016:
                    return _T("Nikon3.ImageBoundary");
                    break; // Short Image boundry
                case 0x0018:
                    return _T("Nikon3.FlashBracketComp");
                    break; // Undefined Flash bracket compensation applied
                case 0x0019:
                    return _T("Nikon3.ExposureBracketComp");
                    break; // SRational AE bracket compensation applied
                case 0x0080:
                    return _T("Nikon3.ImageAdjustment");
                    break; // Ascii Image adjustment setting
                case 0x0081:
                    return _T("Nikon3.ToneComp");
                    break; // Ascii Tone compensation setting (contrast)
                case 0x0082:
                    return _T("Nikon3.AuxiliaryLens");
                    break; // Ascii Auxiliary lens (adapter)
                case 0x0083:
                    return _T("Nikon3.LensType");
                    break; // Byte Lens type
                case 0x0084:
                    return _T("Nikon3.Lens");
                    break; // Rational Lens
                case 0x0085:
                    return _T("Nikon3.FocusDistance");
                    break; // Rational Manual focus distance
                case 0x0086:
                    return _T("Nikon3.DigitalZoom");
                    break; // Rational Digital zoom setting
                case 0x0087:
                    return _T("Nikon3.FlashType");
                    break; // Byte Type of flash used
                case 0x0088:
                    return _T("Nikon3.AFFocusPos");
                    break; // Undefined AF focus position
                case 0x0089:
                    return _T("Nikon3.Bracketing");
                    break; // Short Bracketing
                case 0x008b:
                    return _T("Nikon3.LensFStops");
                    break; // Undefined Number of lens stops
                case 0x008c:
                    return _T("Nikon3.ToneCurve");
                    break; // Undefined Tone curve
                case 0x008d:
                    return _T("Nikon3.ColorMode");
                    break; // Ascii Color mode
                case 0x008f:
                    return _T("Nikon3.SceneMode");
                    break; // Ascii Scene mode
                case 0x0090:
                    return _T("Nikon3.LightingType");
                    break; // Ascii Lighting type
                case 0x0092:
                    return _T("Nikon3.HueAdjustment");
                    break; // SShort Hue adjustment
                case 0x0094:
                    return _T("Nikon3.Saturation");
                    break; // SShort Saturation adjustment
                case 0x0095:
                    return _T("Nikon3.NoiseReduction");
                    break; // Ascii Noise reduction
                case 0x0096:
                    return _T("Nikon3.CompressionCurve");
                    break; // Undefined Compression curve
                case 0x0097:
                    return _T("Nikon3.ColorBalance2");
                    break; // Undefined Color balance 2
                case 0x0098:
                    return _T("Nikon3.LensData");
                    break; // Undefined Lens data
                case 0x0099:
                    return _T("Nikon3.NEFThumbnailSize");
                    break; // Short NEF thumbnail size
                case 0x009a:
                    return _T("Nikon3.SensorPixelSize");
                    break; // Rational Sensor pixel size
                case 0x00a0:
                    return _T("Nikon3.SerialNumber");
                    break; // Ascii Camera serial number
                case 0x00a7:
                    return _T("Nikon3.ShutterCount");
                    break; // Long Number of shots taken by camera
                case 0x00a9:
                    return _T("Nikon3.ImageOptimization");
                    break; // Ascii Image optimization
                case 0x00aa:
                    return _T("Nikon3.Saturation");
                    break; // Ascii Saturation
                case 0x00ab:
                    return _T("Nikon3.VariProgram");
    ...
    if (m_strImgExifMake == _T("NIKON"))
    {
        ...
        if (strTmp == _T("Nikon"))
        {
            ...
            else
            {
                ...
                m_pLog->AddLineErr(strTmp.GetString());
                return FALSE;
            }
        }
        else
...
unsigned CjfifDecode::DecodeExifIfd(CString strIfd,unsigned nPosExifStart,unsigned nStartIfdPtr)
{
    ...
    strTmp.Format(_T("  EXIF %s @ Absolute 0x%08X"),(LPCTSTR)strIfd.GetString(),m_nPos);
    ...
    strTmp.Format(_T("strIfd=[%s] m_strImgExifMake=[%s]"),(LPCTSTR)strIfd.GetString(),(LPCTSTR)m_strImgExifMake.GetString());
    DbgAddLine(strTmp.GetString());
    ...
    if (strIfd == _T("MakerIFD"))
    {
        ...
        {
            strTmp.Format(_T("    Makernotes not yet supported for [%s]"),(LPCTSTR)m_strImgExifMake.GetString());
            m_pLog->AddLine(strTmp.GetString());
    ...
    for (unsigned nIfdEntryInd=0; nIfdEntryInd<nIfdDirLen; nIfdEntryInd++)
    {
        ...
        strTmp.Format(_T("      Tag # = 0x%04X = [%s]"),nIfdTagVal,(LPCTSTR)strIfdTag.GetString());
        DbgAddLine(strTmp.GetString());
        ...
        if (nIfdNumComps > 4000)
        {
            ...
            if (strIfdTag.Compare(_T("MakerNote"))!=0)
            {
                ...
                m_pLog->AddLineWarn(strTmp.GetString());
            }
            nIfdNumComps = 4000;
        }
        ...
        case 3:
            ...
            else if (nIfdNumComps > MAX_IFD_COMPS)
            {
                ...
                DbgAddLine(strValTmp.GetString());
        ...
        case 4:
            ...
            {
                strTmp.Format(_T("%s / %u"),(LPCTSTR)strValOut.GetString(),anValues[0]);
                strValOut = strTmp;
            }
            break;
        ...
        else if (strIfdTag == _T("GPSAltitudeRef"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Above Sea Level");
                break;
            case 1 :
                strValOut = _T("Below Sea Level");
                break;
            }
        }
        else if (strIfdTag == _T("GPSStatus"))
        {
            ...
            {
            case 'A' :
                strValOut = _T("Measurement in progress");
                break;
            case 'V' :
                strValOut = _T("Measurement Interoperability");
                break;
            }
        }
        else if (strIfdTag == _T("GPSMeasureMode"))
        {
            ...
            {
            case '2' :
                strValOut = _T("2-dimensional");
                break;
            case '3' :
                strValOut = _T("3-dimensional");
                break;
            }
        }
                 ...
                 (strIfdTag == _T("GPSDestBearingRef")))
        {
            ...
            {
            case 'T' :
                strValOut = _T("True direction");
                break;
            case 'M' :
                strValOut = _T("Magnetic direction");
                break;
            }
        }
        else if (strIfdTag == _T("GPSDifferential"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Measurement without differential correction");
                break;
            case 1 :
                strValOut = _T("Differential correction applied");
                break;
            }
        }
        ...
        else if (strIfdTag == _T("ExposureTime"))
        {
            // Assume only one
            strValTmp = strValOut;
            strValOut.Format(_T("%s s"),(LPCTSTR)strValTmp.GetString());
        }
        ...
        else if (strIfdTag == _T("Orientation"))
        {
            ...
            {
            case 1 :
                strValOut = _T("1 = Row 0: top, Col 0: left");
                break;
            case 2 :
                strValOut = _T("2 = Row 0: top, Col 0: right");
                break;
            case 3 :
                strValOut = _T("3 = Row 0: bottom, Col 0: right");
                break;
            case 4 :
                strValOut = _T("4 = Row 0: bottom, Col 0: left");
                break;
            case 5 :
                strValOut = _T("5 = Row 0: left, Col 0: top");
                break;
            case 6 :
                strValOut = _T("6 = Row 0: right, Col 0: top");
                break;
            case 7 :
                strValOut = _T("7 = Row 0: right, Col 0: bottom");
                break;
            case 8 :
                strValOut = _T("8 = Row 0: left, Col 0: bottom");
                break;
            }
        }
        else if (strIfdTag == _T("PlanarConfiguration"))
        {
            ...
            {
            case 1 :
                strValOut = _T("Chunky format");
                break;
            case 2 :
                strValOut = _T("Planar format");
                break;
            }
        }
        ...
        else if (strIfdTag == _T("YCbCrPositioning"))
        {
            ...
            {
            case 1 :
                strValOut = _T("Centered");
                break;
            case 2 :
                strValOut = _T("Co-sited");
                break;
            }
        }
        ...
        else if (strIfdTag == _T("MeteringMode"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Unknown");
                break;
            case 1 :
                strValOut = _T("Average");
                break;
            case 2 :
                strValOut = _T("CenterWeightedAverage");
                break;
            case 3 :
                strValOut = _T("Spot");
                break;
            case 4 :
                strValOut = _T("MultiSpot");
                break;
            case 5 :
                strValOut = _T("Pattern");
                break;
            case 6 :
                strValOut = _T("Partial");
                break;
            case 255 :
                strValOut = _T("Other");
                break;
        ...
        else if (strIfdTag == _T("ExposureProgram"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Not defined");
                break;
            case 1 :
                strValOut = _T("Manual");
                break;
            case 2 :
                strValOut = _T("Normal program");
                break;
            case 3 :
                strValOut = _T("Aperture priority");
                break;
            case 4 :
                strValOut = _T("Shutter priority");
                break;
            case 5 :
                strValOut = _T("Creative program (depth of field)");
                break;
            case 6 :
                strValOut = _T("Action program (fast shutter speed)");
                break;
            case 7 :
                strValOut = _T("Portrait mode");
                break;
            case 8 :
                strValOut = _T("Landscape mode");
                break;
            }
        }
        else if (strIfdTag == _T("Flash"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Flash did not fire");
                break;
            case 1 :
                strValOut = _T("Flash fired");
                break;
            }
        ...
        else if (strIfdTag == _T("SensingMethod"))
        {
            ...
            case 1 :
                ...
                break;
            case 2 :
                strValOut = _T("One-chip color area sensor");
                break;
            case 3 :
                strValOut = _T("Two-chip color area sensor");
                break;
            case 4 :
                strValOut = _T("Three-chip color area sensor");
                break;
            case 5 :
                strValOut = _T("Color sequential area sensor");
                break;
            case 7 :
                strValOut = _T("Trilinear sensor");
                break;
            case 8 :
                strValOut = _T("Color sequential linear sensor");
                break;
            }
        }
        ...
        else if (strIfdTag == _T("CustomRendered"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Normal process");
                break;
            case 1 :
                strValOut = _T("Custom process");
                break;
            }
        }
        else if (strIfdTag == _T("ExposureMode"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Auto exposure");
                break;
            case 1 :
                strValOut = _T("Manual exposure");
                break;
            case 2 :
                strValOut = _T("Auto bracket");
                break;
            }
        }
        else if (strIfdTag == _T("WhiteBalance"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Auto white balance");
                break;
            case 1 :
                strValOut = _T("Manual white balance");
                break;
            }
        }
        else if (strIfdTag == _T("SceneCaptureType"))
        {
            ...
            {
            case 0 :
                strValOut = _T("Standard");
                break;
            case 1 :
                strValOut = _T("Landscape");
                break;
            case 2 :
                strValOut = _T("Portrait");
                break;
            case 3 :
                strValOut = _T("Night scene");
                break;
            }
        }
        else if (strIfdTag == _T("SceneType"))
        {
            ...
            {
            case 1 :
                strValOut = _T("A directly photographed image");
                break;
            }
        }
        else if (strIfdTag == _T("LightSource"))
        {
            ...
            case 0 :
                ...
                break;
            case 1 :
                strValOut = _T("Daylight");
                break;
            case 2 :
                strValOut = _T("Fluorescent");
                break;
            case 3 :
                strValOut = _T("Tungsten (incandescent light)");
                break;
            case 4 :
                strValOut = _T("Flash");
                break;
            case 9 :
                strValOut = _T("Fine weather");
                break;
            case 10 :
                strValOut = _T("Cloudy weather");
                break;
            case 11 :
                strValOut = _T("Shade");
                break;
            case 12 :
                strValOut = _T("Daylight fluorescent (D 5700  7100K)");
                break;
            case 13 :
                strValOut = _T("Day white fluorescent (N 4600  5400K)");
                break;
            case 14 :
                strValOut = _T("Cool white fluorescent (W 3900  4500K)");
                break;
            case 15 :
                strValOut = _T("White fluorescent (WW 3200  3700K)");
                break;
            case 17 :
                strValOut = _T("Standard light A");
                break;
            case 18 :
                strValOut = _T("Standard light B");
                break;
            case 19 :
                strValOut = _T("Standard light C");
                break;
            case 20 :
                strValOut = _T("D55");
                break;
            ...
            case 23 :
                ...
                break;
            case 24 :
                strValOut = _T("ISO studio tungsten");
                break;
            case 255 :
                strValOut = _T("other light source");
                break;
            }
        }
        ...
        if (strIfdTag == _T("CFAPattern"))
        {
            ...
            {
                bExtraDecode = TRUE;
                strTmp.Format(_T("    [%-36s] ="),(LPCTSTR)strIfdTag.GetString());
                m_pLog->AddLine(strTmp.GetString());
                    ...
                    for (unsigned nX=0; nX<nHorzRepeat; nX++)
                    {
                        if (nInd<MAX_anValues)
                        {
                            ...
                            case 6:
                                ...
                                break;
                            default:
                                strCol.Format(_T("x%02X"),nVal);
                                break;
                            }
                            strLine.AppendFormat(_T("%s "),(LPCTSTR)strCol.GetString());
                        }
                    }
                    strLine.append(_T("]"));
                    m_pLog->AddLine(strLine.GetString());
                }
            }
        ...
        if (strIfd == _T("MakerIFD"))
        {
                ...
                if (1 || (!nIfdTagUnknown))
                {
                    ...
                    for (unsigned ind=0; ind<nIfdNumComps; ind++)
                    {
                        ...
                        if (ind<MAX_anValues)
                        {
                            ...
                            strValTmp.Format(_T("      [%-34s] = %s"),(LPCTSTR)strMaker.GetString(),(LPCTSTR)(strRetVal.strVal.GetString()));
                            if (1 || (!strRetVal.bUnknown))
                            {
                    ...
                    (strIfdTag=="Sigma.Quality") )
            {
                ...
                strTmp = _T("");
                strTmp.Format(_T("[%s]:[%s],"),(LPCTSTR)strIfdTag.GetString(),(LPCTSTR)strValOut.GetString());
        ...
        if (!bExtraDecode)
        {
            ...
            if (1 || (!nIfdTagUnknown))
            {
                ...
                if (nIfdFormat == 2)
                {
                    strTmp.Format(_T("    [%-36s] = \"%s\""),(LPCTSTR)strIfdTag.GetString(),(LPCTSTR)strValOut.GetString());
                }
                else
                {
                    strTmp.Format(_T("    [%-36s] = %s"),(LPCTSTR)strIfdTag.GetString(),(LPCTSTR)strValOut.GetString());
...
unsigned CjfifDecode::DecodeIccHeader(unsigned nPos)
{
    ...
    strTmp.Format(_T("        %-33s : %s"),_T("Preferred CMM Type"),(LPCTSTR)Uint2Chars(nPrefCmmType).GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    {
    case 'scnr':
        strTmp1.Format(_T("Input Device profile"));
        break;
    case 'mntr':
        strTmp1.Format(_T("Display Device profile"));
        break;
    case 'prtr':
        strTmp1.Format(_T("Output Device profile"));
        break;
    case 'link':
        strTmp1.Format(_T("DeviceLink Device profile"));
        break;
    case 'spac':
        strTmp1.Format(_T("ColorSpace Conversion profile"));
        break;
    case 'abst':
        strTmp1.Format(_T("Abstract profile"));
        break;
    case 'nmcl':
        strTmp1.Format(_T("Named colour profile"));
        break;
    default:
        strTmp1.Format(_T("? (0x%08X)"),nProfDevClass);
        break;
    }
    strTmp.Format(_T("        %-33s : %s (%s)"),_T("Profile Device/Class"),(LPCTSTR)strTmp1.GetString(),(LPCTSTR)Uint2Chars(nProfDevClass).GetString());
    m_pLog->AddLine(strTmp.GetString());

    switch (nDataColorSpace)
    {
    case 'XYZ ':
        strTmp1.Format(_T("XYZData"));
        break;
    case 'Lab ':
        strTmp1.Format(_T("labData"));
        break;
    case 'Luv ':
        strTmp1.Format(_T("lubData"));
        break;
    case 'YCbr':
        strTmp1.Format(_T("YCbCrData"));
        break;
    case 'Yxy ':
        strTmp1.Format(_T("YxyData"));
        break;
    case 'RGB ':
        strTmp1.Format(_T("rgbData"));
        break;
    case 'GRAY':
        strTmp1.Format(_T("grayData"));
        break;
    case 'HSV ':
        strTmp1.Format(_T("hsvData"));
        break;
    case 'HLS ':
        strTmp1.Format(_T("hlsData"));
        break;
    case 'CMYK':
        strTmp1.Format(_T("cmykData"));
        break;
    case 'CMY ':
        strTmp1.Format(_T("cmyData"));
        break;
    case '2CLR':
        strTmp1.Format(_T("2colourData"));
        break;
    case '3CLR':
        strTmp1.Format(_T("3colourData"));
        break;
    case '4CLR':
        strTmp1.Format(_T("4colourData"));
        break;
    case '5CLR':
        strTmp1.Format(_T("5colourData"));
        break;
    case '6CLR':
        strTmp1.Format(_T("6colourData"));
        break;
    case '7CLR':
        strTmp1.Format(_T("7colourData"));
        break;
    case '8CLR':
        strTmp1.Format(_T("8colourData"));
        break;
    case '9CLR':
        strTmp1.Format(_T("9colourData"));
        break;
    case 'ACLR':
        strTmp1.Format(_T("10colourData"));
        break;
    case 'BCLR':
        strTmp1.Format(_T("11colourData"));
        break;
    case 'CCLR':
        strTmp1.Format(_T("12colourData"));
        break;
    case 'DCLR':
        strTmp1.Format(_T("13colourData"));
        break;
    case 'ECLR':
        strTmp1.Format(_T("14colourData"));
        break;
    case 'FCLR':
        strTmp1.Format(_T("15colourData"));
        break;
    default:
        strTmp1.Format(_T("? (0x%08X)"),nDataColorSpace);
        break;
    }
    strTmp.Format(_T("        %-33s : %s (%s)"),_T("Data Colour Space"),(LPCTSTR)strTmp1.GetString(),(LPCTSTR)Uint2Chars(nDataColorSpace).GetString());
    m_pLog->AddLine(strTmp.GetString());

    strTmp.Format(_T("        %-33s : %s"),_T("Profile connection space (PCS)"),(LPCTSTR)Uint2Chars(nPcs).GetString());
    m_pLog->AddLine(strTmp.GetString());

    strTmp.Format(_T("        %-33s : %s"),_T("Profile creation date"),(LPCTSTR)DecodeIccDateTime(anDateTimeCreated).GetString());
    m_pLog->AddLine(strTmp.GetString());

    strTmp.Format(_T("        %-33s : %s"),_T("Profile file signature"),(LPCTSTR)Uint2Chars(nProfFileSig).GetString());
    m_pLog->AddLine(strTmp.GetString());

    switch (nPrimPlatSig)
    {
    case 'APPL':
        strTmp1.Format(_T("Apple Computer, Inc."));
        break;
    case 'MSFT':
        strTmp1.Format(_T("Microsoft Corporation"));
        break;
    case 'SGI ':
        strTmp1.Format(_T("Silicon Graphics, Inc."));
        break;
    case 'SUNW':
        strTmp1.Format(_T("Sun Microsystems, Inc."));
        break;
    default:
        strTmp1.Format(_T("? (0x%08X)"),nPrimPlatSig);
        break;
    }
    strTmp.Format(_T("        %-33s : %s (%s)"),_T("Primary platform"),(LPCTSTR)strTmp1.GetString(),(LPCTSTR)Uint2Chars(nPrimPlatSig).GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    strTmp.Format(_T("        %-35s > %s"),_T("Profile flags"),(LPCTSTR)strTmp1.GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    strTmp.Format(_T("        %-33s : %s"),_T("Device Manufacturer"),(LPCTSTR)Uint2Chars(nDevManuf).GetString());
    m_pLog->AddLine(strTmp.GetString());

    strTmp.Format(_T("        %-33s : %s"),_T("Device Model"),(LPCTSTR)Uint2Chars(nDevModel).GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    strTmp.Format(_T("        %-35s > %s"),_T("Device attributes"),(LPCTSTR)strTmp1.GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    {
    case 0x00000000:
        strTmp1.Format(_T("Perceptual"));
        break;
    case 0x00000001:
        strTmp1.Format(_T("Media-Relative Colorimetric"));
        break;
    case 0x00000002:
        strTmp1.Format(_T("Saturation"));
        break;
    case 0x00000003:
        strTmp1.Format(_T("ICC-Absolute Colorimetric"));
        break;
    default:
        strTmp1.Format(_T("0x%08X"),nRenderIntent);
        break;
    }
    strTmp.Format(_T("        %-33s : %s"),_T("Rendering intent"),(LPCTSTR)strTmp1.GetString());
    m_pLog->AddLine(strTmp.GetString());

    // PCS illuminant

    strTmp.Format(_T("        %-33s : %s"),_T("Profile creator"),(LPCTSTR)Uint2Chars(nProfCreatorSig).GetString());
    m_pLog->AddLine(strTmp.GetString());
...
unsigned CjfifDecode::DecodeApp2Flashpix()
{
    ...
    if (nFpxSegType == 1)
    {
        ...
        for (unsigned ind=0; ind<nFpxInteropCnt; ind++)
        {
            ...
            strTmp.Format(_T("        Stream Name = [%s]"),(LPCTSTR)streamStr.GetString());
            m_pLog->AddLine(strTmp.GetString());
            ...
            if (bFpxStorage)
            {
                ...
                m_nPos+= 16;
                strTmp.Format(_T("        Storage Class = [%s]"),(LPCTSTR)strFpxStorageClsStr.GetString());
                m_pLog->AddLine(strTmp.GetString());
    ...
    else if (nFpxSegType == 2)
    {
        ...
        strTmp.Format(_T("      clsid = %s"),(LPCTSTR)strFpxStClsidStr.GetString());
        m_pLog->AddLine(strTmp.GetString());
...
#define DECODE_DHT_MAX_DHT 256
        ...
        for (unsigned int nIndLen=1; ((!m_bStateAbort)&&(nIndLen<=MAX_DHT_CODELEN)); nIndLen++)
        {
            ...
            for (unsigned int nIndCode=0; ((!m_bStateAbort)&&(nIndCode<m_anDhtNumCodesLen_Li[nIndLen])); nIndCode++)
            {
                ...
                if ((nIndCode % 16) == 15)
                {
                    m_pLog->AddLine(strFull.GetString());
                    strFull = _T("");
                }
            ...
            if (m_anDhtNumCodesLen_Li[nBitLen] > 0)
            {
                ...
                for (unsigned int bit_ind=1; ((!m_bStateAbort)&&(bit_ind<=m_anDhtNumCodesLen_Li[nBitLen])); bit_ind++)
                {
                    ...
                    if (1)
                    {
                        ...
                        strTmp.Format(_T("%-40s (Total Len = %2u)"),(LPCTSTR)strFull.GetString(),nBitLen + (anDhtCodeVal[nDhtInd] & 0xF));
    ...
    else
    {
        if (nVal < nMin)
        {
            strErr.Format(_T("  ERROR: %s value too small (Actual = %u, Expected >= %u)"),
                          (LPCTSTR)strName.GetString(),nVal,nMin);
            m_pLog->AddLineErr(strErr.GetString());
        }
        else if (nVal > nMax)
        {
            strErr.Format(_T("  ERROR: %s value too large (Actual = %u, Expected <= %u)"),
                          (LPCTSTR)strName.GetString(),nVal,nMax);
            m_pLog->AddLineErr(strErr.GetString());
        }
        if (0)
        {
        ...
        else
        {
            ...
            if (bOverride)
            {
                ...
                m_pLog->AddLineWarn(strErr.GetString());
                m_pLog->AddLineWarn(_T("  Resuming decode"));
            }
            else
            {
...
unsigned CjfifDecode::DecodeMarker()
{
    ...
    if (nSkipMarkerPad>0)
    {
        ...
        m_pLog->AddLineHdr(strTmp.GetString());
    }
    ...
    case JFIF_APP1:
        ...
        if (!strncmp(acIdentifier,_T("http://ns.adobe.com/xap/1.0/\x00"),29) != 0)
        {
            // XMP
        ...
        else if (!strcmp(acIdentifier,_T("Exif")) != 0)
        {
    ...
    case JFIF_APP0: // APP0
        ...
        if (!strcmp(m_acApp0Identifier,_T("JFIF")))
        {
            ...
            default:
                ...
                strFull += strTmp;
                m_pLog->AddLineWarn(strFull.GetString());
                //return DECMARK_ERR;
                break;
            }
        ...
        else if (!strncmp(m_acApp0Identifier,_T("AVI1"),4))
        {
            // AVI MJPEG type
...
//XXX        strTmp.Format(_T("  Table length <Lq> = %u"),nLength);
        ...
        while (nPosEnd > m_nPos)
        {
            ...
            strTmp.Format(_T("  Precision=%s"),(LPCTSTR)strDqtPrecision.GetString());
            m_pLog->AddLine(strTmp.GetString());
...
void CjfifDecode::AddHeader(unsigned nCode)
{
    ...
    {
    case JFIF_SOI:
        m_pLog->AddLineHdr(_T("*** Marker: SOI (xFFD8) ***"));
        break;

    case JFIF_APP0:
        m_pLog->AddLineHdr(_T("*** Marker: APP0 (xFFE0) ***"));
        break;
    case JFIF_APP1:
        m_pLog->AddLineHdr(_T("*** Marker: APP1 (xFFE1) ***"));
        break;
    case JFIF_APP2:
        m_pLog->AddLineHdr(_T("*** Marker: APP2 (xFFE2) ***"));
        break;
    case JFIF_APP3:
        m_pLog->AddLineHdr(_T("*** Marker: APP3 (xFFE3) ***"));
        break;
    case JFIF_APP4:
        m_pLog->AddLineHdr(_T("*** Marker: APP4 (xFFE4) ***"));
        break;
    case JFIF_APP5:
        m_pLog->AddLineHdr(_T("*** Marker: APP5 (xFFE5) ***"));
        break;
    case JFIF_APP6:
        m_pLog->AddLineHdr(_T("*** Marker: APP6 (xFFE6) ***"));
        break;
    case JFIF_APP7:
        m_pLog->AddLineHdr(_T("*** Marker: APP7 (xFFE7) ***"));
        break;
    case JFIF_APP8:
        m_pLog->AddLineHdr(_T("*** Marker: APP8 (xFFE8) ***"));
        break;
    case JFIF_APP9:
        m_pLog->AddLineHdr(_T("*** Marker: APP9 (xFFE9) ***"));
        break;
    case JFIF_APP10:
        m_pLog->AddLineHdr(_T("*** Marker: APP10 (xFFEA) ***"));
        break;
    case JFIF_APP11:
        m_pLog->AddLineHdr(_T("*** Marker: APP11 (xFFEB) ***"));
        break;
    case JFIF_APP12:
        m_pLog->AddLineHdr(_T("*** Marker: APP12 (xFFEC) ***"));
        break;
    case JFIF_APP13:
        m_pLog->AddLineHdr(_T("*** Marker: APP13 (xFFED) ***"));
        break;
    case JFIF_APP14:
        m_pLog->AddLineHdr(_T("*** Marker: APP14 (xFFEE) ***"));
        break;
    case JFIF_APP15:
        m_pLog->AddLineHdr(_T("*** Marker: APP15 (xFFEF) ***"));
        break;
    ...
    case JFIF_SOF0:
        ...
        break;
    case JFIF_SOF1:
        m_pLog->AddLineHdr(_T("*** Marker: SOF1 (Extended Sequential DCT, Huffman) (xFFC1) ***"));
        break;
    case JFIF_SOF2:
        m_pLog->AddLineHdr(_T("*** Marker: SOF2 (Progressive DCT, Huffman) (xFFC2) ***"));
        break;
    case JFIF_SOF3:
        m_pLog->AddLineHdr(_T("*** Marker: SOF3 (Lossless Process, Huffman) (xFFC3) ***"));
        break;
    case JFIF_SOF5:
        m_pLog->AddLineHdr(_T("*** Marker: SOF5 (Differential Sequential DCT, Huffman) (xFFC4) ***"));
        break;
    case JFIF_SOF6:
        m_pLog->AddLineHdr(_T("*** Marker: SOF6 (Differential Progressive DCT, Huffman) (xFFC5) ***"));
        break;
    case JFIF_SOF7:
        m_pLog->AddLineHdr(_T("*** Marker: SOF7 (Differential Lossless Process, Huffman) (xFFC6) ***"));
        break;
    case JFIF_SOF9:
        m_pLog->AddLineHdr(_T("*** Marker: SOF9 (Sequential DCT, Arithmetic) (xFFC9) ***"));
        break;
    case JFIF_SOF10:
        m_pLog->AddLineHdr(_T("*** Marker: SOF10 (Progressive DCT, Arithmetic) (xFFCA) ***"));
        break;
    case JFIF_SOF11:
        m_pLog->AddLineHdr(_T("*** Marker: SOF11 (Lossless Process, Arithmetic) (xFFCB) ***"));
        break;
    case JFIF_SOF13:
        m_pLog->AddLineHdr(_T("*** Marker: SOF13 (Differential Sequential, Arithmetic) (xFFCD) ***"));
        break;
    case JFIF_SOF14:
        m_pLog->AddLineHdr(_T("*** Marker: SOF14 (Differential Progressive DCT, Arithmetic) (xFFCE) ***"));
        break;
    case JFIF_SOF15:
        m_pLog->AddLineHdr(_T("*** Marker: SOF15 (Differential Lossless Process, Arithmetic) (xFFCF) ***"));
        break;

    case JFIF_JPG:
        m_pLog->AddLineHdr(_T("*** Marker: JPG (xFFC8) ***"));
        break;
    case JFIF_DAC:
        m_pLog->AddLineHdr(_T("*** Marker: DAC (xFFCC) ***"));
        break;
    ...
    case JFIF_DNL:
        m_pLog->AddLineHdr(_T("*** Marker: DNL (Define Number of Lines) (xFFDC) ***"));
        break;
    case JFIF_DHP:
        m_pLog->AddLineHdr(_T("*** Marker: DHP (Define Hierarchical Progression) (xFFDE) ***"));
        break;
    case JFIF_EXP:
        m_pLog->AddLineHdr(_T("*** Marker: EXP (Expand Reference Components) (xFFDF) ***"));
        break;
    case JFIF_JPG0:
        m_pLog->AddLineHdr(_T("*** Marker: JPG0 (JPEG Extension) (xFFF0) ***"));
        break;
    case JFIF_JPG1:
        m_pLog->AddLineHdr(_T("*** Marker: JPG1 (JPEG Extension) (xFFF1) ***"));
        break;
    case JFIF_JPG2:
        m_pLog->AddLineHdr(_T("*** Marker: JPG2 (JPEG Extension) (xFFF2) ***"));
        break;
    case JFIF_JPG3:
        m_pLog->AddLineHdr(_T("*** Marker: JPG3 (JPEG Extension) (xFFF3) ***"));
        break;
    case JFIF_JPG4:
        m_pLog->AddLineHdr(_T("*** Marker: JPG4 (JPEG Extension) (xFFF4) ***"));
        break;
    case JFIF_JPG5:
        m_pLog->AddLineHdr(_T("*** Marker: JPG5 (JPEG Extension) (xFFF5) ***"));
        break;
    case JFIF_JPG6:
        m_pLog->AddLineHdr(_T("*** Marker: JPG6 (JPEG Extension) (xFFF6) ***"));
        break;
    case JFIF_JPG7:
        m_pLog->AddLineHdr(_T("*** Marker: JPG7 (JPEG Extension) (xFFF7) ***"));
        break;
    case JFIF_JPG8:
        m_pLog->AddLineHdr(_T("*** Marker: JPG8 (JPEG Extension) (xFFF8) ***"));
        break;
    case JFIF_JPG9:
        m_pLog->AddLineHdr(_T("*** Marker: JPG9 (JPEG Extension) (xFFF9) ***"));
        break;
    case JFIF_JPG10:
        m_pLog->AddLineHdr(_T("*** Marker: JPG10 (JPEG Extension) (xFFFA) ***"));
        break;
    case JFIF_JPG11:
        m_pLog->AddLineHdr(_T("*** Marker: JPG11 (JPEG Extension) (xFFFB) ***"));
        break;
    case JFIF_JPG12:
        m_pLog->AddLineHdr(_T("*** Marker: JPG12 (JPEG Extension) (xFFFC) ***"));
        break;
    case JFIF_JPG13:
        m_pLog->AddLineHdr(_T("*** Marker: JPG13 (JPEG Extension) (xFFFD) ***"));
        break;
    case JFIF_TEM:
        m_pLog->AddLineHdr(_T("*** Marker: TEM (Temporary) (xFF01) ***"));
        break;
...
void CjfifDecode::OutputSpecial()
{
    ...
    if (m_bOutputDB)
    {
        ...
        strTmp.Format(_T("'%s', "),(LPCTSTR)m_strImgExifMake.GetString());
        strFull += strTmp; // make

        strTmp.Format(_T("'%s', "),(LPCTSTR)m_strImgExifModel.GetString());
        strFull += strTmp; // model

        strTmp.Format(_T("'%s', "),(LPCTSTR)m_strImgQualExif.GetString());
        strFull += strTmp; // quality

        strTmp.Format(_T("'%s', "),(LPCTSTR)m_strImgQuantCss.GetString());
...
bool CjfifDecode::CompareSignature(bool bQuiet=false)
{
    ...
    strTmp.Format(_T("  File Offset:         %lu bytes"),0);
    m_pLog->AddLine(strTmp.GetString());

    // Output the CSS
    strTmp.Format(_T("  Chroma subsampling:  %s"),(LPCTSTR)m_strImgQuantCss.GetString());
    m_pLog->AddLine(strTmp.GetString());
    ...
    {
        strTmp.Format(_T("  EXIF Make/Model:     OK   [%s] [%s]"),(LPCTSTR)m_strImgExifMake.GetString(),(LPCTSTR)m_strImgExifModel.GetString());
        m_pLog->AddLine(strTmp.GetString());
        bCurXmm = true;
    }
    ...
    {
        strTmp.Format(_T("  EXIF Software:       OK   [%s]"),(LPCTSTR)m_strSoftware.GetString());
        m_pLog->AddLine(strTmp.GetString());
    ...
    unsigned nSigsInternal = m_pDbSigs->GetNumSigsInternal();
    unsigned nSigsExtra = m_pDbSigs->GetNumSigsExtra();
    ...
    CompSig pEntry;
    unsigned ind_max = m_pDbSigs->GetDBNumEntries();
    for (ind=0; ind<ind_max; ind++)
    {
        ...
        if (curMatchSig)
        {
            if (pEntry.eEditor==ENUM_EDITOR_CAM)
            {
                strTmp.Format(_T("    %s%4s[%-25s] [%-35s] [%-16s] %-5s %-5s %-5s"),(LPCTSTR)locationStr.GetString(),_T("CAM:"),
                              (LPCTSTR)pEntry.strXMake.Left(25).GetString(),(LPCTSTR)pEntry.strXModel.Left(35).GetString(),(LPCTSTR)pEntry.strUmQual.Left(16).GetString(),
                              (curMatchSigCss?_T("Yes"):_T("No")),_T(""),_T(""));
            }
            else if (pEntry.eEditor==ENUM_EDITOR_SW)
            {
                strTmp.Format(_T("    %s%4s[%-25s]  %-35s  [%-16s] %-5s %-5s %-5s"),(LPCTSTR)locationStr.GetString(),_T("SW :"),
                              (LPCTSTR)pEntry.strMSwDisp.Left(25).GetString(),_T(""),(LPCTSTR)pEntry.strUmQual.Left(16).GetString(),
                              _T(""),_T(""),_T(""));
            }
            else
            {
                strTmp.Format(_T("    %s%4s[%-25s] [%-35s] [%-16s] %-5s %-5s %-5s"),(LPCTSTR)locationStr.GetString(),_T("?? :"),
                              (LPCTSTR)pEntry.strXMake.Left(25).GetString(),(LPCTSTR)pEntry.strXModel.Left(35).GetString(),(LPCTSTR)pEntry.strUmQual.Left(16).GetString(),
                              _T(""),_T(""),_T(""));
            }
            if (curMatchMm || curMatchSw)
            {
                m_pLog->AddLineGood(strTmp.GetString());
            }
            else
            {
                m_pLog->AddLine(strTmp.GetString());
    ...
    if (bMatchIjg)
    {
        ...
        for (ind=0; ind<nIjgNum; ind++)
        {
            ...
            strTmp.Format(_T("     %4s[%-25s]  %-35s  [%-16s] %-5s %-5s %-5s"),_T("SW :"),
                          (LPCTSTR)strIjgSw.Left(25).GetString(),_T(""),(LPCTSTR)sMatchIjgQual.Left(16).GetString(),
                          _T(""),_T(""),_T(""));
            m_pLog->AddLine(strTmp.GetString());
        }
    }
...
void CjfifDecode::DecodeEmbeddedThumb()
{
    ...
    if (m_nImgExifThumbComp == 6)
    {
            ...
            if (!bDone)
            {
                ...
                case JFIF_DQT:  // Define quantization tables
                    ...
                    while (nPosEnd > m_nPos)
                    {
                        ...
                        strTmp.Format(_T("    Precision=%s"),(LPCTSTR)strPrecision.GetString());
                        m_pLog->AddLine(strTmp.GetString());
                        strTmp.Format(_T("    Destination ID=%u"),nDqtQuantDestId_Tq);
                ...
                default:
                    ...
                    strTmp.Format(_T("  * Embedded Thumb Marker: %s"),(LPCTSTR)strMarker.GetString());
                    m_pLog->AddLine(strTmp.GetString());
                    nLength = Buf(m_nPos)*256 + Buf(m_nPos+1);
                    strTmp.Format(_T("    Length = %u"),nLength);
                    m_pLog->AddLine(strTmp.GetString());
        ...
        if (!bErrorAny)
        {
            ...
            m_pLog->AddLine(_T(""));
            strTmp.Format(_T("  * Embedded Thumb Signature: %s"),(LPCTSTR)m_strHashThumb.GetString());
            m_pLog->AddLine(strTmp.GetString());
        }
...
bool CjfifDecode::DecodeAvi()
{
    ...
    while (!done)
    {
        ...
        m_nPos+=4;
        strTmp.Format(_T("  %s"),(LPCTSTR)strHeader.GetString());
        m_pLog->AddLine(strTmp.GetString());
        ...
        if (strHeader == _T("LIST"))
        {
            ...
            strTmp.Format(_T("    %s"),(LPCTSTR)strListType.GetString());
            m_pLog->AddLine(strTmp.GetString());
            ...
            else if (strListType == _T("strl"))
            {
                ...
                if (fccType == _T("vids"))
                {
                    fccTypeDecode = _T("[vids] Video");
                }
                else if (fccType == _T("auds"))
                {
                    fccTypeDecode = _T("[auds] Audio");
                }
                else if (fccType == _T("txts"))
                {
                    fccTypeDecode = _T("[txts] Subtitle");
                }
                else
                {
                    fccTypeDecode.Format(_T("[%s]"),(LPCTSTR)fccType.GetString());
                }
                strTmp.Format(_T("      -[FourCC Type]  = %s"),(LPCTSTR)fccTypeDecode.GetString());
                m_pLog->AddLine(strTmp.GetString());

                strTmp.Format(_T("      -[FourCC Codec] = [%s]"),(LPCTSTR)fccHandler.GetString());
                m_pLog->AddLine(strTmp.GetString());
                ...
                if (fccType == _T("vids"))
                {
                    strTmp.append(_T(" frames/sec"));
                }
                else if (fccType == _T("auds"))
                {
                    strTmp.append(_T(" samples/sec"));
                }
                m_pLog->AddLine(strTmp.GetString());

                m_nPos = nPosStrlStart + nStrhLen;    // Skip

                strTmp.Format(_T("      %s"),(LPCTSTR)fccType.GetString());
                m_pLog->AddLine(strTmp.GetString());
            ...
            else if (strListType == _T("INFO"))
            {
                ...
                if (strInfoId == _T("ISFT"))
                {
                    ...
                    strIsft.TrimRight();
                    strTmp.Format(_T("      -[Software] = [%s]"),(LPCTSTR)strIsft.GetString());
                    m_pLog->AddLine(strTmp.GetString());
                }
        ...
        else if (strHeader == _T("IDIT"))
        {
            ...
            strTmp.Format(_T("    -[Timestamp] = [%s]"),(LPCTSTR)strIditTimestamp.GetString());
            m_pLog->AddLine(strTmp.GetString());
